...
def run():
    with sync_playwright() as p:
        ...
        print("Clicking Import Pattern")
        try:
            page.get_by_role("button", name="Import Pattern").click(timeout=3000)
        except Exception as e:
            print("Import Pattern button not found:", e)

        page.wait_for_timeout(2000)

        print("Taking screenshot")
        page.screenshot(path="stitch_check2.png")
