...
fs.writeFileSync(path.join('creator', 'import-wizard-bundle.js'), wizardBundle, 'utf8');
const wkb = (wizardBundle.length / 1024).toFixed(1);
console.log(`creator/import-wizard-bundle.js written — ${wizardBundle.length} bytes (${wkb} KB), ${WIZARD_ORDER.length} files merged`);
